...
```
#Chance of Admitance 
I am going to do a 70/30 split of trainibg and testing data. There are 500 observations so we will have 350 training observations and 150 testing points. 
```{r}
...
As seen from the Importance Plot the most important variables are most CGPA, GRE Score and TOEFL scores are the most important when using chance of admission as a response variable. 
